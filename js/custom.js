...
$(document).ready(function ($) {
    ...
    $('.filters .btn-group button').click(function () {
        setTimeout(() => {
            ...
            $('.filters .btn-group button').removeClass('active');
            $(this).addClass('active');


            $(".ts-gallery .ts-gallery__item").removeClass('nm-show');
            $(".ts-gallery .ts-gallery__item").removeClass('nm-hide');
            if (id !== "all") {
                $(".ts-gallery .ts-gallery__item").addClass('nm-hide');
                document.querySelectorAll(`[data-filter-item='${id}']`).forEach(item => {
                    item.classList.add('nm-show');
                });
            }
            else {
                $(".ts-gallery .ts-gallery__item").removeClass('nm-hide');
...
$(document).ready(function () {
    var $magic = $(".magic"),
        ...
        var prevX, prevY = 0;
    $('.magic-wrap').on("mousemove", function (e) {
        setTimeout(() => {
            $magic.css({ "left": e.pageX - magicWHalf, "top": e.pageY - magicWHalf, "transition" : "1s"});
            prevX = e.pageX;
            prevY = e.pageY;
        }, 200);
    });
